...
public class TaskManagerTest {
    ...
    public void setUp() {
        ...
        taskManager.addTask("Refentse Masa", "Create Login", "1", 5, "To Do");
        taskManager.addTask("Mofenyi Ngobs", "Create Add Features", "2", 8, "Doing");
        taskManager.addTask("Lethabo Labs", "Create Reports", "3", 2, "Done");
        taskManager.addTask("Ofentse Matts", "Add Arrays", "4", 11, "To Do");
    }
    ...
    public void testGetLongestTask() {
        ...
        String expected = "Task with longest duration: Add Arrays, Developer: Ofentse Matts, Duration: 11 hours";
    ...
    public void testGetTasksWithStatus() {
        ...
        String status = "To Do";
        String expected = "Developer: Refentse Masa, Task Name: Create Login, Duration: 5 hours\n" +
                          "Developer: Ofentse Matts, Task Name: Add Arrays, Duration: 11 hours\n";
    ...
    public void testSearchTaskByName() {
        ...
        String expected = "Task: Create Login, Developer: Refentse Masa, Status: To Do";
    ...
    public void testSearchTasksByDeveloper() {
        ...
        String developerName = "Lethabo Laps";
    ...
    public void testGetAllTasksReport() {
        ...
        String expected = "Developer: Refentse Masa , Task Name: Create Login, Task ID: 1, Duration: 5 hours, Status: To Do\n" +
                          "Developer: Mofenyi Ngobs, Task Name: Create Add Features, Task ID: 2, Duration: 8 hours, Status: Doing\n" +
                          "Developer: Lethabo Laps, Task Name: Create Reports, Task ID: 3, Duration: 2 hours, Status: Done\n" +
                          "Developer: Ofentse Matts, Task Name: Add Arrays, Task ID: 4, Duration: 11 hours, Status: To Do\n";
